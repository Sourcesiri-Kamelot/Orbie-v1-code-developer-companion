    ...
    const tableLoaderFunctionRolePolicy = new Policy(scope, 'TableLoaderFunctionRolePolicy', {
      statements: [
        new PolicyStatement({
          ...
          resources: [tableLoaderFunctionLogGroup.logGroupArn],
        }),
        new PolicyStatement({
        ...
        new PolicyStatement({
          ...
          resources: [`arn:aws:s3:::${this.repoConfigFile.bucket.bucketName}/*`, `arn:aws:s3:::${this.repoConfigFile.bucket.bucketName}`],
        }),
        new PolicyStatement({
